# Problem statement
# Given a a straight sidewalk measured in fixed integer range. Ex. 1-10 centermeter
# Implement a class such that
# given input number of rain drops at different intervals, which wets 1 centermeter to the left and to the right
# correctly return if the sidewalk is wet or not, meaning the entire sidewalk from Ex. 1-10 centermeter is wet.

class RainDrop:
    def __init__(self, l):
        # [0,0,0] stands for [filled, left wet amount, right wet amount]
